...
public class LuaState {
	...
	public synchronized JavaFunction getMetamethod(Object obj,
		...
		if (obj != null && obj instanceof LuaError)
		{
	...
	public synchronized void lError(String err) {
		check();
		luaL_error(err);
	}
	 ...
	 * 			  index
	 */
	public synchronized void pushJavaClosure(JavaFunction javaFunction, int i) {
		check();
		lua_pushjavaclosure(javaFunction, i);
	}
	...
	public synchronized void pushLightJavaObject(Object object) {
		check();
		lua_pushlightjavaobject(object);
	}

	public synchronized void pushLightUserData(Object object) {
		check();
		lua_pushlightuserdata(object);
	}

	public synchronized void newJavaObject(Object object) {
		check();
		lua_newjavaobject(object);
	}
	...
	public synchronized Object toLightJavaObjectRaw(int index) {
		check();
		return lua_tolightjavaobject(index);
	}
	...
	private native void lua_pushjavaclosure(JavaFunction f, int i);

	private native void lua_pushjavaobject(Object object);

	private native void lua_pushlightjavaobject(Object object);

	private native void lua_pushlightuserdata(Object object);

	private native void lua_newjavaobject(Object object);
	...
	private native Object lua_tolightjavaobject(int index);
	...
	private native void luaL_error(String err);

	public static native void setasset(AssetManager manager);

	public static native long hvaluew(long val);

	public long hvalue(long valTValue)
	{
		check();
		return hvaluew(valTValue);
	}

	public static native int sizenodew(long val);

	public int sizenode(long valTable)
	{
		check();
		return sizenodew(valTable);
	}

	public static native long gnodew(long val, int index);

	public long gnode(long valTable, int index)
	{
		check();
		return gnodew(valTable, index);
	}

	public static native long key2tvalw(long val);

	public long key2tval(long valNode)
	{
		check();
		return key2tvalw(valNode);
	}

	public static native int ttypew(long val);

	public int ttype(long valTValue)
	{
		check();
		return ttypew(valTValue);
	}

	public static native String svaluew(long val);

	public String svalue(long valTValue)
	{
		check();
		return svaluew(valTValue);
	}

	public static native double nvaluew(long val);

	public double nvalue(long valTValue)
	{
		check();
		return nvaluew(valTValue);
	}

	public static native long pvaluew(long val);

	public long pvalue(long valTValue)
	{
		check();
		return pvaluew(valTValue);
	}

	public static native long luaH_getw(long table, long val);

	public long luaH_get(long valTable, long valTValue)
	{
		check();
		return luaH_getw(valTable, valTValue);
	}
